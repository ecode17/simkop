...
<section style="background: #f7fafc;min-height:80vh; padding-top: 10px;">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9 col-md-10">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <a href="<?= site_url('news') ?>" class="btn btn-outline-success rounded-pill px-4">
                        <i class="bi bi-arrow-left"></i> Kembali ke Daftar Berita
                    </a>
                    <!-- Jika ingin tombol share -->
                    <!--
                    <div>
                        <a href="https://wa.me/?text=<?= urlencode(current_url()) ?>" target="_blank" class="btn btn-sm btn-outline-success rounded-pill me-2">
                            <i class="bi bi-whatsapp"></i> Share WhatsApp
                        </a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode(current_url()) ?>" target="_blank" class="btn btn-sm btn-outline-primary rounded-pill">
